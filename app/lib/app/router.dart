...
/// Placeholder for server detail page
class ServerDetailPlaceholder extends StatelessWidget {
  final String serverId;

  const ServerDetailPlaceholder({super.key, required this.serverId});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Server: $serverId')),
      body: const Center(child: Text('Server detail coming soon...')),
    );
  }
}
...
class AlertsPlaceholder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(child: Text('Alerts page coming soon...')),
    );
  }
}
