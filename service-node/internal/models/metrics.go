...
// AlertCondition represents the comparison condition for an alert.
...
const (
	...
	ConditionNotEqual       AlertCondition = "neq"
)
...
type AlertRule struct {
	...
	NotifyChannels  []uuid.UUID    `json:"notify_channels"`
...
const (
	...
	ChannelTypeSMTP    NotificationChannelType = "smtp"
